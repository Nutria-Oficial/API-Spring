...
public class IngredienteController implements IngredienteApi {
  ...
  public ResponseEntity<List<ResponseIngredienteDTO>> getAllIngredientes() {
    List<ResponseIngredienteDTO> responseIngredienteDTO =
  ...
  @Override
  @PostMapping
  public ResponseEntity<ResponseIngredienteDTO> criarIngrediente(
      @Valid @RequestBody RequestIngredienteDTO ingrediente) {
    ResponseIngredienteDTO responseIngredienteDTO =
